...
# plt.plot(ages_x, dev_y, label="All Devs", color="#444444", linestyle="--")
# plt.plot(ages_x, py_dev_y, label="Python", color="#008800", linestyle="-", linewidth=3)
# plt.plot(ages_x, js_dev_y, label="JS", color="Yellow", linestyle="-", marker=".", linewidth=3)

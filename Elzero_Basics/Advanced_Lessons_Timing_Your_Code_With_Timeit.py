...
print(timeit.timeit(stmt="random.randint(1,100)", setup="import random", timer=time.perf_counter))  # Wall Clock
print(timeit.timeit(stmt="random.randint(1,100)", setup="import random", timer=time.process_time))  # CPU Time
